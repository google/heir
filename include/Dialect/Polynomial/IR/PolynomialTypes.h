#ifndef INCLUDE_DIALECT_POLYNOMIAL_IR_POLYNOMIALTYPES_H_
#define INCLUDE_DIALECT_POLYNOMIAL_IR_POLYNOMIALTYPES_H_
...
#endif  // INCLUDE_DIALECT_POLYNOMIAL_IR_POLYNOMIALTYPES_H_
