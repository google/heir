...
class ContextAwareTypeConverter {
 public:
  ...
  /// HEIR: added Operation * argument for the context.
  LogicalResult convertSignatureArg(Operation *op, unsigned inputNo, Type type,
                                    SignatureConversion &result) const;
  LogicalResult convertSignatureArgs(Operation *op, TypeRange types,
...
// FIXME: replace with generic ContextAwareOpConversionPattern?
