...
CKKSLinearTransformOp::getRotationIndices() {
  ...
  // after it, and this accessor is reachable in both states -- notably from
  // --rotation-analysis run on a dumped, already-bufferized module. Match on
  // ShapedType so it does not assert on legal IR.
