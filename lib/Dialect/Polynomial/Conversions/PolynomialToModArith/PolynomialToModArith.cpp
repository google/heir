...
Value modArithReduceOp(CommonConversionInfo<Op> &c, ImplicitLocOpBuilder &b,
                       ConversionPatternRewriter &rewriter, Value v,
                       int64_t shape = 0) {
  // Not using c.tensorType here because of a
  ...
  // type
  if (c.tensorElementWidth == c.coefficientModulusWidth) {
    ...
    v = b.create<arith::TruncIOp>(resultType, v);
             ...
             c.tensorElementWidth > c.coefficientModulusWidth) {
...
struct ConvertFromTensor : public OpConversionPattern<FromTensorOp> {
  ...
  LogicalResult matchAndRewrite(
    ...
    coeffValue =
        modArithReduceOp<FromTensorOp>(c, b, rewriter, coeffValue, inputShape);
...
struct ConvertConstant : public OpConversionPattern<ConstantOp> {
  ...
  LogicalResult matchAndRewrite(
    ...
    constantOp = modArithReduceOp(c, b, rewriter, constantOp, c.tensorShape);
...
struct ConvertMulScalar : public OpConversionPattern<MulScalarOp> {
  ...
  LogicalResult matchAndRewrite(
    ...
    Value scalar =
        modArithReduceOp<MulScalarOp>(c, b, rewriter, adaptor.getScalar());
