...
struct ConfigureCryptoContext
  ...
  void runOnOperation() override {
    ...
    solver.load<mul_depth_analysis::MulDepthAnalysis>();
    ...
    getOperation()->walk([&](Operation *op) {
      ...
      const mul_depth_analysis::MulDepthLattice *resultLattice =
          solver.lookupState<mul_depth_analysis::MulDepthLattice>(
              op->getResult(0));
