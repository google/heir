  ...
  void runOnOperation() override {
    ...
    if (!beforeMulIncludeFirstMul && !afterMul) {
      ...
      patternsMulDepth.add<MatchCrossMulDepth<arith::SubIOp>>(
          &getContext(), &scaleCounter, getOperation(), &solver);
      patternsMulDepth.add<MatchCrossMulDepth<arith::MulFOp>>(
          &getContext(), &scaleCounter, getOperation(), &solver);
      patternsMulDepth.add<MatchCrossMulDepth<arith::AddFOp>>(
          &getContext(), &scaleCounter, getOperation(), &solver);
      patternsMulDepth.add<MatchCrossMulDepth<arith::SubFOp>>(
          &getContext(), &scaleCounter, getOperation(), &solver);
