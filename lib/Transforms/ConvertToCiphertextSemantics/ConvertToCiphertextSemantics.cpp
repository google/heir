...
class ConvertAssignLayout
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    Attribute domainScheduleAttr = op.getDomainScheduleAttr();
    FunctionKey key(layout, inputType, resultType, domainScheduleAttr);
 ...
 private:
  ...
  // (LayoutAttribute, InputType, ResultType, DomainScheduleAttribute). Layout
  // is uniqued by the layout string.
  using FunctionKey = std::tuple<Attribute, Type, Type, Attribute>;
