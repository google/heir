...
struct ConvertLinalgMatmul
 ...
 public:
  ...
  void bicyclicDiagonalKernel(
    ...
    int64_t reach = kernel::rotateAndReduceRotationReach(period, steps);
  ...
  void bicyclicKernel(linalg::MatmulOp op, OpAdaptor adaptor,
    ...
    auto dataSemanticResultType =
        cast<RankedTensorType>(op->getResult(0).getType());
    int64_t reach = kernel::bicyclicMatmulRotationReach(
...
struct ConvertLinalgBatchMatmul
 ...
 public:
  ...
  void tricyclicKernel(linalg::BatchMatmulOp op, OpAdaptor adaptor,
    ...
    auto dataSemanticResultType =
        cast<RankedTensorType>(op->getResult(0).getType());
    int64_t reach = kernel::tricyclicBatchMatmulRotationReach(
        lhsType.getShape()[0], lhsType.getShape()[1], lhsType.getShape()[2],
        rhsType.getShape()[2]);
    auto ctSemanticResultType =
        cast<RankedTensorType>(addBias->getResult(0).getType());
    int64_t validPrefix = ctSemanticResultType.getDimSize(1) - reach;
