...
LogicalResult LattigoEmitter::printOperation(BGVRotateColumnsNewOp op) {
  ...
  if (op.getOffset().has_value()) {
    ...
    return op.emitError("RotateColumnsNewOp must have either offset attribute or shift operand");
  }
...
LogicalResult LattigoEmitter::printOperation(BGVRotateColumnsOp op) {
  ...
  if (op.getOffset().has_value()) {
    ...
    return op.emitError("RotateColumnsOp must have either offset attribute or shift operand");
  }
...
LogicalResult LattigoEmitter::printOperation(CKKSRotateNewOp op) {
  ...
  if (op.getOffset().has_value()) {
    ...
    return op.emitError("CKKSRotateNewOp must have either offset attribute or shift operand");
  }
...
LogicalResult LattigoEmitter::printOperation(CKKSRotateOp op) {
  ...
  if (op.getOffset().has_value()) {
    ...
    return op.emitError("CKKSRotateOp must have either offset attribute or shift operand");
  }
