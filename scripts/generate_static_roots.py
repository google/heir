...
def main(args: argparse.Namespace) -> None:
  degrees = args.degrees if args.degrees else [
      # 2**8 -> 2**16
      256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536
  ]
  cmods = args.cmods if args.cmods else [
      # 32-bit primes
      65537, 114689, 147457, 163841, 557057, 638977, 737281, 786433, 1032193,
      1179649, 1769473, 1785857, 2277377, 2424833, 2572289, 2654209, 2752513,
      2768897, 8380417, 2147565569, 2148155393, 2148384769, 3221225473,
      3221241857, 3758161921,
      # 64-bit primes
      4295049217, 8590163969, 17180295169, 34359771137, 68720066561,
      137439510529
  ]
