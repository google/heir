...
// It demonstrates add, multiply, rotate, and scalar operations
...
func.func @polynomial_evaluation(%x: tensor<16xf32> {secret.secret}, %y: tensor<16xf32> {secret.secret}) -> tensor<16xf32> {
  ...
  // Add a rotation to show SIMD slot manipulation
  %c4 = arith.constant 4 : i32
  %rotated = tensor_ext.rotate %result, %c4 : tensor<16xf32>, i32
  %final = arith.addf %result, %rotated : tensor<16xf32>
