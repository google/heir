...
// CHECK-DAG: !ctx = !cheddar.context
// CHECK-DAG: !encoder = !cheddar.encoder
// CHECK-DAG: !ui = !cheddar.user_interface
// CHECK-DAG: !ct = !cheddar.ciphertext
module @jit_func attributes {backend.cheddar, ckks.schemeParam = #ckks.scheme_param<logN = 13, Q = [36028797018652673, 35184372121601], P = [1152921504606994433], logDefaultScale = 45>, scheme.ckks} {
// CHECK: func.func @mnist__preprocessed(%ctx: !ctx, %encoder: !encoder, %ui: !ui
// CHECK: %arg1: tensor<1x!ct>
// CHECK: func.func public @mnist(%ctx: !ctx, %encoder: !encoder, %ui: !ui
// CHECK: %arg1: tensor<1x!ct>
// CHECK: %0 = call @_assign_layout_11979326689855340354(%arg0)
// CHECK: %1 = call @mnist__preprocessed(%ctx, %encoder, %ui, %0, %arg1) : (!ctx, !encoder, !ui, tensor<512x1024xf32>, tensor<1x!ct>) -> tensor<1x!ct>
