...
module attributes {scheme.ckks, ckks.schemeParam = #ckks.scheme_param<logN = 13, Q = [536903681, 67043329, 66994177, 67239937, 66961409, 66813953], P = [536952833, 536690689], logDefaultScale = 26>} {
  func.func @linear_transform(%arg0: tensor<2x4096xf64>, %arg1: !ct_L5) -> !ct_L5 {
    %0 = orion.linear_transform %arg1, %arg0 {block_col = 0 : i32, block_row = 0 : i32, bsgs_ratio = 2.000000e+00 : f64, diagonal_count = 2 : i32, orion_level = 5 : i32, slots = 4096 : i32, diagonal_indices = array<i32: 0, 1>} : (!ct_L5, tensor<2x4096xf64>) -> !ct_L5
    return %0 : !ct_L5
  }
}
