// RUN: not heir-opt --lwe-to-jaxiteword %s 2>&1 | FileCheck %s
...
#key = #lwe.key<>
#modulus_chain_L5_C1_ = #lwe.modulus_chain<elements = <1095233372161 : i64, 1032955396097 : i64>, current = 1>
...
module {
  func.func @test_nonconstant_rotate(%ct: !ct_L1_, %shift: index) -> !ct_L1_ {
    %rotated = ckks.rotate %ct, %shift : index : !ct_L1_
    return %rotated : !ct_L1_
  }
}

// CHECK: failed to legalize operation 'ckks.rotate'
