...
// CHECK-SAME:  !polynomial.polynomial<ring = <coefficientType = !mod_arith.int<7917 : i32>, polynomialModulus = <1 + x**1024>>>
// CHECK-SAME:  tensor<2x!polynomial.polynomial<ring = <coefficientType = !mod_arith.int<7917 : i32>, polynomialModulus = <1 + x**1024>>>>
