// RUN: heir-opt --ckks-decompose-relinearize --ckks-decompose-keyswitch --ckks-to-lwe --lwe-to-polynomial --convert-polynomial-mul-to-ntt --attach-ntt-roots --split-rns-ntt %s
