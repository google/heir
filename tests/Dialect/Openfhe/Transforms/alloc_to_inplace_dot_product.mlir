...
func.func @dot_product(%cc: !cc, %ct: !ct, %ct_0: !ct) -> !ct {
  ...
  %ct_3 = openfhe.rot %cc, %ct_2 {index = 4 : index} : (!cc, !ct) -> !ct
  %ct_4 = openfhe.add %cc, %ct_2, %ct_3 : (!cc, !ct, !ct) -> !ct
  %ct_5 = openfhe.rot %cc, %ct_4 {index = 2 : index} : (!cc, !ct) -> !ct
  %ct_6 = openfhe.add %cc, %ct_4, %ct_5 : (!cc, !ct, !ct) -> !ct
  %ct_7 = openfhe.rot %cc, %ct_6 {index = 1 : index} : (!cc, !ct) -> !ct
  ...
  %ct_12 = openfhe.rot %cc, %ct_11 {index = 7 : index} : (!cc, !ct) -> !ct
