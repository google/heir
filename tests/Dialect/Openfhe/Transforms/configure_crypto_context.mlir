...
func.func @simple_sum(%arg0: !openfhe.crypto_context, %arg1: !ct) -> !ct {
  ...
  %0 = openfhe.rot %arg0, %arg1 {static_shift = 16 : index} : (!openfhe.crypto_context, !ct) -> !ct
  %1 = openfhe.add %arg0, %arg1, %0 : (!openfhe.crypto_context, !ct, !ct) -> !ct
  %2 = openfhe.rot %arg0, %1 {static_shift = 8 : index} : (!openfhe.crypto_context, !ct) -> !ct
  %3 = openfhe.add %arg0, %1, %2 : (!openfhe.crypto_context, !ct, !ct) -> !ct
  %4 = openfhe.rot %arg0, %3 {static_shift = 4 : index} : (!openfhe.crypto_context, !ct) -> !ct
  %5 = openfhe.add %arg0, %3, %4 : (!openfhe.crypto_context, !ct, !ct) -> !ct
  %6 = openfhe.rot %arg0, %5 {static_shift = 2 : index} : (!openfhe.crypto_context, !ct) -> !ct
  %7 = openfhe.add %arg0, %5, %6 : (!openfhe.crypto_context, !ct, !ct) -> !ct
  %8 = openfhe.rot %arg0, %7 {static_shift = 1 : index} : (!openfhe.crypto_context, !ct) -> !ct
  ...
  %12 = openfhe.rot %arg0, %11 {static_shift = 31 : index} : (!openfhe.crypto_context, !ct) -> !ct
