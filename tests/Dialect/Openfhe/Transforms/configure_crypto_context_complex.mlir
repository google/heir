// RUN: heir-opt --annotate-module="backend=openfhe scheme=bgv" --secretize --wrap-generic --cse --canonicalize --secret-insert-mgmt-bgv --generate-param-bgv --secret-distribute-generic --secret-to-bgv=min-slot-count=32 --bgv-to-lwe --lwe-to-openfhe --openfhe-configure-crypto-context=entry-function=complex_func %s | FileCheck %s
