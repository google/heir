// RUN: heir-opt --secretize --wrap-generic --cse --canonicalize --secret-insert-mgmt-bgv --secret-distribute-generic --secret-to-bgv=poly-mod-degree=32 --bgv-to-openfhe --openfhe-configure-crypto-context=entry-function=complex_func %s | FileCheck %s
