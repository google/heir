...
module {
  ...
  func.func @ops(%arg0: !secret.secret<i3>, %arg1: !secret.secret<i3>, %arg2: !secret.secret<i3>, %arg3: !secret.secret<i3>) -> !secret.secret<i3> {
    ...
    %0 = secret.cast %arg0 : !secret.secret<i3> to !secret.secret<memref<3xi1>>
    %1 = secret.cast %arg1 : !secret.secret<i3> to !secret.secret<memref<3xi1>>
    %2 = secret.cast %arg2 : !secret.secret<i3> to !secret.secret<memref<3xi1>>
    %3 = secret.cast %arg3 : !secret.secret<i3> to !secret.secret<memref<3xi1>>
    %4 = secret.generic(%0: !secret.secret<memref<3xi1>>, %1: !secret.secret<memref<3xi1>>, %2: !secret.secret<memref<3xi1>>, %3: !secret.secret<memref<3xi1>>) {
    ^body(%input0: memref<3xi1>, %input1: memref<3xi1>, %input2: memref<3xi1>, %input3: memref<3xi1>):
      %6 = memref.load %input1[%c0] : memref<3xi1>
      %7 = memref.load %input0[%c0] : memref<3xi1>
      %8 = comb.truth_table %false, %6, %7 -> 4 : ui8
      %9 = memref.load %input1[%c1] : memref<3xi1>
      %10 = memref.load %input0[%c1] : memref<3xi1>
      %11 = comb.truth_table %9, %10, %8 -> 178 : ui8
      %12 = memref.load %input0[%c2] : memref<3xi1>
      %13 = memref.load %input1[%c2] : memref<3xi1>
      %14 = comb.truth_table %12, %13, %11 -> 105 : ui8
      %15 = memref.load %input2[%c0] : memref<3xi1>
      %16 = comb.truth_table %false, %15, %14 -> 4 : ui8
      %17 = comb.truth_table %false, %10, %9 -> 9 : ui8
      %18 = memref.load %input2[%c1] : memref<3xi1>
      %19 = comb.truth_table %18, %17, %8 -> 144 : ui8
      %20 = comb.truth_table %false, %7, %6 -> 9 : ui8
      %21 = memref.load %input2[%c2] : memref<3xi1>
      ...
      %26 = memref.load %input3[%c2] : memref<3xi1>
      %27 = comb.truth_table %26, %25, %16 -> 96 : ui8
      %28 = memref.load %input3[%c0] : memref<3xi1>
      %29 = comb.truth_table %28, %15, %20 -> 64 : ui8
      %30 = memref.load %input3[%c1] : memref<3xi1>
      %31 = comb.truth_table %30, %24, %23 -> 96 : ui8
      %alloc = memref.alloc() : memref<3xi1>
      memref.store %29, %alloc[%c0] : memref<3xi1>
      memref.store %31, %alloc[%c1] : memref<3xi1>
      memref.store %27, %alloc[%c2] : memref<3xi1>
      secret.yield %alloc : memref<3xi1>
    } -> !secret.secret<memref<3xi1>>
    %5 = secret.cast %4 : !secret.secret<memref<3xi1>> to !secret.secret<i3>
