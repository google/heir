...
func.func @test_absorb_dealloc(%memref : !secret.secret<memref<1xi32>>) {
  ...
  // CHECK: %[[Z:.*]] = secret.generic(%[[Y]]: !secret.secret<memref<1xi32>>, %[[C0]]: i32)
  %Z:2 = secret.generic(%memref: !secret.secret<memref<1xi32>>, %C7: i32) {
  ...
  // CHECK: secret.generic(%[[Z1:.*]]: !secret.secret<memref<1xi32>>)
  secret.generic(%Z#1 : !secret.secret<memref<1xi32>>) {
