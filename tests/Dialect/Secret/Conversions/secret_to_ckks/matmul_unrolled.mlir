// RUN: heir-opt --annotate-module="backend=openfhe scheme=ckks" --secretize --wrap-generic --full-loop-unroll --secret-insert-mgmt-ckks --secret-distribute-generic --canonicalize --secret-to-ckks %s | FileCheck %s
