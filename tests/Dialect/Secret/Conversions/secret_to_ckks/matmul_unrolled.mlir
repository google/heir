// RUN: heir-opt --mlir-print-local-scope --annotate-module="backend=openfhe scheme=ckks" --secretize --wrap-generic --full-loop-unroll --secret-insert-mgmt-ckks=slot-number=16 --generate-param-ckks --populate-scale-ckks --secret-distribute-generic --canonicalize --secret-to-ckks %s | FileCheck %s
