...
// RUN: heir-opt --mlir-print-local-scope --secret-insert-mgmt-ckks --generate-param-ckks --populate-scale-ckks --secret-distribute-generic --canonicalize --secret-to-ckks --split-input-file %s | FileCheck %s

// CHECK: func @test_arg_packed
...
// CHECK: func @test_extract_not_packed
...
// CHECK: func @test_add_scalar_not_packed
...
// CHECK: func @test_add_plain_scalar_not_packed
// CHECK-SAME: !lwe.new_lwe_ciphertext<{{.*}}message_type = f32{{.*}}>
