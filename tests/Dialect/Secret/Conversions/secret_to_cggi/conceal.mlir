...
// CHECK: @conceal
// CHECK-SAME: ([[ARG:%.*]]: i3) -> [[TY:tensor<3x!lwe.lwe_ciphertext<.*>>]]
...
// CHECK-SAME: ([[ARG:%.*]]: tensor<3xi1>) -> [[TY:tensor<3x!lwe.lwe_ciphertext<.*>>]]
...
// CHECK-SAME: ([[ARG:%.*]]: tensor<3xi2>) -> [[TY:tensor<3x2x!lwe.lwe_ciphertext<.*>>]]
...
// CHECK: @conceal_i1
// CHECK-SAME: ([[ARG:%.*]]: i1) -> [[TY:!lwe.lwe_ciphertext<.*>]]
...
// CHECK: @conceal_MxN
// CHECK-SAME: ([[ARG:%.*]]: tensor<3x3xi1>) -> [[TY:tensor<3x3x!lwe.lwe_ciphertext<.*>>]]
