...
// expected-error@below {{The affine map's input size (2) must match the number of dimensions of alignment.out (1)}}
...
// expected-error@below {{The affine map's input size (1) must match the number of dimensions of alignment.out (2)}}
