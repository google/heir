...
// CHECK: #[[simd_packing:[^ ]*]] = #tensor_ext.simd_packing<in = [16], padding = [0], out = [1024]>
// CHECK: @main
// CHECK-SAME: !secret.secret<tensor<1024xi16, #[[simd_packing]]>>
func.func @main(%arg0: tensor<16xi16>, %arg1: tensor<16xi16>) -> tensor<16xi16> {
  // CHECK-NEXT: secret.generic ins(%[[arg0:.*]]: !secret.secret<[[ty:.*]]>, %[[arg1:.*]]: !secret.secret<[[ty]]>)
...
// CHECK: #[[simd_packing:[^ ]*]] = #tensor_ext.simd_packing<in = [2048], padding = [0], out = [2, 1024]>
// CHECK: @main
// CHECK-SAME: %[[arg0:.*]]:
// CHECK-SAME: tensor<2x1024xi16, #[[simd_packing]]>
