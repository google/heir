...
// Regression for #1039: multidimensional tensors are not supported in PartialReductionRotateAnalysis.
...
module {
  ...
  func.func @matmul(%arg0: !secret.secret<tensor<1x16xf32>>) -> !secret.secret<tensor<1x16xf32>> {
    ...
    %1 = secret.generic(%arg0: !secret.secret<tensor<1x16xf32>>, %0: !secret.secret<tensor<1x16xf32>>) {
