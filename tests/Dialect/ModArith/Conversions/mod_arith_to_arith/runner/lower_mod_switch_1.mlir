...
// RUN:   | mlir-runner -e test_lower_mod_switch_1 -entry-point-result=void \
// RUN:      --shared-libs="%mlir_lib_dir/libmlir_c_runner_utils%shlibext,%mlir_runner_utils" > %t
// RUN: FileCheck %s --check-prefix=CHECK_TEST_MOD_SWITCH_1 < %t
...
func.func @test_lower_mod_switch_1() {
  // 57543298 is -9565566
...
// CHECK_TEST_MOD_SWITCH_1: [265, 43, 7]
