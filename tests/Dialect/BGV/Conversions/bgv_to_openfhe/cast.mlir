...
func.func @encode_i16(%arg0: tensor<32xi16>, %arg1: !pk) -> !pt_i16 {
  ...
  // CHECK:     openfhe.make_packed_plaintext %[[cc]], %[[v0]] {{.*}} tensor<32xi64>) -> !lwe.new_lwe_plaintext{{.*}} tensor<32xi16>
  // CHECK-NOT: openfhe.make_packed_plaintext {{.*}} tensor<32xi16> -> !lwe.new_lwe_plaintext{{.*}} tensor<32xi16>
  return %0 : !pt_i16
}
...
func.func @encode_i32(%arg0: tensor<32xi32>, %arg1: !pk) -> !pt_i32 {
  ...
  // CHECK:     openfhe.make_packed_plaintext %[[cc]], %[[v0]] {{.*}} tensor<32xi64>) -> !lwe.new_lwe_plaintext{{.*}} tensor<32xi32>
  // CHECK-NOT: openfhe.make_packed_plaintext {{.*}} : tensor<32xi32> -> !lwe.new_lwe_plaintext{{.*}} tensor<32xi32>
  return %0 : !pt_i32
}
...
func.func @encode_scalar(%arg0: i64, %arg1: !pk) -> !pt_scalar {
  %0 = lwe.rlwe_encode %arg0 {encoding = #full_crt_packing_encoding, ring = #ring_Z65537_i64_1_x32_} : i64 -> !pt_scalar
  // CHECK:     %[[v0:.*]] = tensor.splat
  // CHECK:     openfhe.make_packed_plaintext %[[cc]], %[[v0]] {{.*}} tensor<32xi64>) -> !lwe.new_lwe_plaintext{{.*}} i64
  return %0 : !pt_scalar
}
