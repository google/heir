// RUN: heir-opt --bgv-to-lwe --lwe-to-openfhe --split-input-file --verify-diagnostics %s
...
!ct1 = !lwe.lwe_ciphertext<plaintext_space = #plaintext_space, ciphertext_space = #ciphertext_space_L0_D4_, key = #key, modulus_chain = #modulus_chain_L5_C0_>
...
!pt_scalar = !lwe.lwe_plaintext<plaintext_space = #plaintext_space>
