...
func.func @test_float_small_fc_network(%input : !secret.secret<tensor<1x1xf32>>) -> !secret.secret<tensor<1x1xf32>> {
  ...
  %layer1 = secret.generic (%input : !secret.secret<tensor<1x1xf32>>) {
  ...
  %activation_layer1 = secret.generic (%layer1 : !secret.secret<tensor<1x4xf32>>) {
  ...
  %layer2 = secret.generic (%layer1 : !secret.secret<tensor<1x4xf32>>) {
  ...
  %activation_layer2 = secret.generic (%layer2 : !secret.secret<tensor<1x4xf32>>) {
  ...
  %layer3 = secret.generic (%activation_layer2 : !secret.secret<tensor<1x4xf32>>) {
