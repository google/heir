"""Generate mlir-runner tests for lowering polynomial.mul ops from a config."""
...
# supported by the mlir-runner. So we need to truncate or extend the bits.
# I have not looked into the possibility of adding more functions to the
# upstream mlir-runner.
...
parser = argparse.ArgumentParser(
    description=(
        'Generate a list of mlir-runner integration tests for lowering'
        ' polynomial.mul ops'
    )
)
parser.add_argument(
