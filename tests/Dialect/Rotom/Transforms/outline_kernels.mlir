...
// site carries the kernel's result layout. The kernel body holds the
// rotom.matmul op, whose attributes name every layout of the plan, so the
// materializer and the ciphertext lowering process it like any other
