...
#ring_1 = #polynomial.ring<coefficientType=!mod_arith.int<3721063133:i32>, polynomialModulus=#ideal>
#ring_2 = #polynomial.ring<coefficientType=!mod_arith.int<2737228591:i32>, polynomialModulus=#ideal>
#ring_3 = #polynomial.ring<coefficientType=!mod_arith.int<3180146689:i32>, polynomialModulus=#ideal>
#ring_bad = #polynomial.ring<coefficientType=!mod_arith.int<3180146689:i32>, polynomialModulus=#ideal_2>
