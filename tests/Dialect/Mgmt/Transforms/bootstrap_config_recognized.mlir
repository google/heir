...
// This test ensures that the default backend config is picked up by the mgmt passes.
...
// CHECK-OPENFHE: func.func @main(%arg0: !secret.secret<tensor<8xi8>> {mgmt.mgmt = #mgmt.mgmt<level = 22>})
