...
#ideal_8 = #polynomial.polynomial<1 + x**3>
#ring_8 = #polynomial.ring<cmod=7, ideal=#ideal_8>
!poly_ty_8 = !polynomial.polynomial<#ring_8>

func.func @test_8() {
  %const0 = arith.constant 0 : index
  %0 = polynomial.constant <-4 + x**1> : !poly_ty_8
  %1 = polynomial.constant <-1 + 3x**1> : !poly_ty_8
  %2 = polynomial.mul(%0, %1) : !poly_ty_8


  %3 = polynomial.to_tensor %2 : !poly_ty_8 -> tensor<3xi3>
