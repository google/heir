...
#ideal_3 = #polynomial.polynomial<1 + x**12>
#ring_3 = #polynomial.ring<cmod=15, ideal=#ideal_3>
!poly_ty_3 = !polynomial.polynomial<#ring_3>

func.func @test_3() {
  %const0 = arith.constant 0 : index
  %0 = polynomial.constant <1 + x**10> : !poly_ty_3
  %1 = polynomial.constant <1 + x**11> : !poly_ty_3
  %2 = polynomial.mul(%0, %1) : !poly_ty_3


  %3 = polynomial.to_tensor %2 : !poly_ty_3 -> tensor<12xi4>
