...
#ring_1 = #polynomial.ring<coefficientType = i32, coefficientModulus=2147483647 : i32, polynomialModulus=#ideal_1>
...
// expected_result: Poly(x**11 + x**10 - x**9 + 1, x, domain='ZZ[2147483647]')
// CHECK_TEST_1: {{(1|-2147483646)}}, 0, 0, 0, 0, 0, 0, 0, 0, {{(2147483646|-1)}}, {{(1|-2147483646)}}, {{(1|-2147483646)}}
