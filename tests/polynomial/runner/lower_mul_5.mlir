...
#ideal_5 = #polynomial.polynomial<1 + x**12>
#ring_5 = #polynomial.ring<cmod=16, ideal=#ideal_5>
!poly_ty_5 = !polynomial.polynomial<#ring_5>

func.func @test_5() {
  %const0 = arith.constant 0 : index
  %0 = polynomial.constant <1 + x**2> : !poly_ty_5
  %1 = polynomial.constant <1 + x**3> : !poly_ty_5
  %2 = polynomial.mul(%0, %1) : !poly_ty_5


  %3 = polynomial.to_tensor %2 : !poly_ty_5 -> tensor<12xi4>
