...
#ring = #polynomial.ring<cmod=4294967296, ideal=#poly>
...
func.func @test_monomial_mul() {
  ...
  %1 = polynomial.monomial_mul %0, %monomial_degree : (!polynomial.polynomial<#ring>, index) -> !polynomial.polynomial<#ring>
  return
}
