...
func.func @test_cant_add_unknown_value(%arg0 : !ciphertext) -> !ciphertext {
  // expected-error@below {{uses SSA value with uninitialized noise variance}}
...
//   %2 = lwe.trivial_encrypt %1 : !plaintext to !ciphertext
//   %3 = cggi.and %2, %2 : !ciphertext
//
...
//     // expected-error@below {{uses SSA value with unbounded noise variance}}
