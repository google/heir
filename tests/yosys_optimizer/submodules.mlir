  ...
  func.func @main(%arg0: !secret.secret<memref<1x1xi16>>) -> (!secret.secret<memref<1x1xi8>>) {
    ...
    affine.for %arg1 = 0 to 1 {
      affine.for %arg2 = 0 to 1 {
        // expected-error@+1 {{incompatible with submodule extraction due to secret indices, did you mean to use use-submodules=false?}}
        ...
        %2 = secret.generic ins(%1, %c127_i32 : !secret.secret<i16>, i16) {
