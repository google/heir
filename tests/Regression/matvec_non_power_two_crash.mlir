// RUN: heir-opt %s --annotate-module="backend=lattigo scheme=ckks" --mlir-to-ckks="min-slot-count=1024 greedy-modulus-switch-after-mul=true experimental-disable-loop-unroll=true greedy-level-budget=40 first-mod-bits=55" --scheme-to-lattigo
