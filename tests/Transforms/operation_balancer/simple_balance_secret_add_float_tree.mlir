...
// CHECK:     %[[RET:.*]] = secret.generic(%[[ARG0]]: [[ty]], %[[ARG1]]: [[ty]], %[[ARG2]]: [[ty]], %[[ARG3]]: [[ty]])
...
func.func @simple_balance_secret_add_float_tree(%arg0: !secret.secret<f32>, %arg1 : !secret.secret<f32>,
  ...
  %0 = secret.generic (%arg0: !secret.secret<f32>, %arg1: !secret.secret<f32>, %arg2: !secret.secret<f32>, %arg3: !secret.secret<f32>) {
