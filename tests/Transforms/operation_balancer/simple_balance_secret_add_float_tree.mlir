...
// CHECK:     func.func @simple_balance_secret_add_float_tree(%[[ARG0:.*]]: [[ty:!secret.secret<f32>]], %[[ARG1:.*]]: !secret.secret<f32>, %[[ARG2:.*]]: !secret.secret<f32>, %[[ARG3:.*]]: !secret.secret<f32>)
// CHECK:     %[[RET:.*]] = secret.generic ins(%[[ARG0]]: [[ty]], %[[ARG1]]: [[ty]], %[[ARG2]]: [[ty]], %[[ARG3]]: [[ty]])
// CHECK:     ^body(%[[CONVERTED_ARG0:.*]]: f32, %[[CONVERTED_ARG1:.*]]: f32, %[[CONVERTED_ARG2:.*]]: f32, %[[CONVERTED_ARG3:.*]]: f32):
...
func.func @simple_balance_secret_add_float_tree(%arg0: !secret.secret<f32>, %arg1 : !secret.secret<f32>,
  ...
  %0 = secret.generic ins (%arg0: !secret.secret<f32>, %arg1: !secret.secret<f32>, %arg2: !secret.secret<f32>, %arg3: !secret.secret<f32>) {
