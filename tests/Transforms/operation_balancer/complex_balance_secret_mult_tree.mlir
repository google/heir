...
// CHECK:     %[[RET:.*]]:3 = secret.generic ins(%[[ARG0]]: !secret.secret<i16>, %[[ARG1]]: !secret.secret<i16>, %[[ARG2]]: !secret.secret<i16>, %[[ARG3]]: !secret.secret<i16>, %[[ARG4]]: !secret.secret<i16>, %[[ARG5]]: !secret.secret<i16>, %[[ARG6]]: !secret.secret<i16>)
...
func.func @complex_balance_secret_mult_tree(%arg0: !secret.secret<i16>, %arg1 : !secret.secret<i16>,
  ...
  %out0, %out1, %out2 = secret.generic ins (
