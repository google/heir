...
// CHECK:     func.func @simple_balance_secret_mult_tree(%[[ARG0:.*]]: [[ty:!secret.secret<i16>]], %[[ARG1:.*]]: !secret.secret<i16>, %[[ARG2:.*]]: !secret.secret<i16>, %[[ARG3:.*]]: !secret.secret<i16>)
// CHECK:     %[[RET:.*]] = secret.generic ins(%[[ARG0]]: [[ty]], %[[ARG1]]: [[ty]], %[[ARG2]]: [[ty]], %[[ARG3]]: [[ty]])
// CHECK:     ^body(%[[CONVERTED_ARG0:.*]]: i16, %[[CONVERTED_ARG1:.*]]: i16, %[[CONVERTED_ARG2:.*]]: i16, %[[CONVERTED_ARG3:.*]]: i16):
...
func.func @simple_balance_secret_mult_tree(%arg0: !secret.secret<i16>, %arg1 : !secret.secret<i16>,
  ...
  %0 = secret.generic ins (%arg0: !secret.secret<i16>, %arg1: !secret.secret<i16>, %arg2: !secret.secret<i16>, %arg3: !secret.secret<i16>) {
