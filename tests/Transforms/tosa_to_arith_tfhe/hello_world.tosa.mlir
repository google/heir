...
module attributes {tf_saved_model.semantics} {
  ...
  func.func @main(%arg0: tensor<1x1xi32> {iree.identifier = "serving_default_dense_input:0", tf_saved_model.index_path = ["dense_input"]}) -> (tensor<1x16xi32> {iree.identifier = "StatefulPartitionedCall:0", tf_saved_model.index_path = ["dense_2"]}) attributes {tf_saved_model.exported_names = ["serving_default"]} {
    ...
    %6 = "tosa.fully_connected"(%arg0, %5, %4) {quantization_info = #tosa.conv_quant<input_zp = 0, weight_zp = 0>} : (tensor<1x1xi32>, tensor<16x1xi8>, tensor<16xi32>) -> tensor<1x16xi32>
