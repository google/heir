// RUN: heir-opt --new-layout-propagation=ciphertext-size=16 --fold-convert-layout-into-assign-layout %s | FileCheck %s
...
func.func @vecmat(%arg0: !secret.secret<tensor<16xf32>>) -> !secret.secret<tensor<16xf32>> {
  ...
  ^body(%input0: tensor<16xf32>):
    ...
    %1 = linalg.vecmat ins(%input0, %cst_0 : tensor<16xf32>, tensor<16x16xf32>) outs(%cst : tensor<16xf32>) -> tensor<16xf32>
