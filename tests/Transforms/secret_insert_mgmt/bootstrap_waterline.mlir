...
// CHECK:    %[[v14:.*]]  = mgmt.adjust_scale %[[v13]] {mgmt.mgmt = #mgmt.mgmt<level = 2>, scale = -1 : i64} : f16
// CHECK:    %[[v15:.*]]  = mgmt.modreduce %[[v14]] {mgmt.mgmt = #mgmt.mgmt<level = 1>} : f16
// CHECK:    %[[v16:.*]]  = arith.addf %[[v12]], %[[v15]] {mgmt.mgmt = #mgmt.mgmt<level = 1>} : f16
// CHECK:    secret.yield %[[v16]] : f16
