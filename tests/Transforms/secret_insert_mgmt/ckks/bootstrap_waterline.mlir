...
// CHECK:    %[[v3:.*]] = arith.addf %2, %[[v2]] {mgmt.mgmt = #mgmt.mgmt<level = 2>} : tensor<1x1024xf16>
// CHECK:    %[[v4:.*]] = mgmt.modreduce %[[v3]] {mgmt.mgmt = #mgmt.mgmt<level = 1>} : tensor<1x1024xf16>
// CHECK:    %[[v5:.*]] = arith.addf %4, %[[v4]] {mgmt.mgmt = #mgmt.mgmt<level = 1>} : tensor<1x1024xf16>
...
// CHECK:    %[[v8:.*]] = arith.addf %[[v7]], %[[v7]] {mgmt.mgmt = #mgmt.mgmt<level = 3>} : tensor<1x1024xf16>
// CHECK:    %[[v9:.*]] = mgmt.modreduce %[[v8]] {mgmt.mgmt = #mgmt.mgmt<level = 2>} : tensor<1x1024xf16>
// CHECK:    %[[v10:.*]]  = arith.addf %[[v9]], %[[v9]] {mgmt.mgmt = #mgmt.mgmt<level = 2>} : tensor<1x1024xf16>
// CHECK:    %[[v11:.*]]  = mgmt.modreduce %[[v10]] {mgmt.mgmt = #mgmt.mgmt<level = 1>} : tensor<1x1024xf16>
// CHECK:    %[[v12:.*]]  = arith.addf %[[v11]], %[[v11]] {mgmt.mgmt = #mgmt.mgmt<level = 1>} : tensor<1x1024xf16>
// cross level op
// CHECK:    %[[v13:.*]]  = mgmt.level_reduce %[[input0]] {mgmt.mgmt = #mgmt.mgmt<level = 2>} : tensor<1x1024xf16>
// CHECK:    %[[v14:.*]]  = mgmt.adjust_scale %[[v13]] {id = 0 : i64, mgmt.mgmt = #mgmt.mgmt<level = 2>} : tensor<1x1024xf16>
// CHECK:    %[[v15:.*]]  = mgmt.modreduce %[[v14]] {mgmt.mgmt = #mgmt.mgmt<level = 1>} : tensor<1x1024xf16>
// CHECK:    %[[v16:.*]]  = mgmt.adjust_scale %[[v12]] {id = 1 : i64, mgmt.mgmt = #mgmt.mgmt<level = 1>} : tensor<1x1024xf16>
// CHECK:    %[[v17:.*]]  = arith.addf %[[v16]], %[[v15]] {mgmt.mgmt = #mgmt.mgmt<level = 1>} : tensor<1x1024xf16>
