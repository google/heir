...
// CHECK: dot_product
// CHECK: secret.secret<tensor<1024xi16>>
func.func @dot_product(%arg0: !secret.secret<tensor<8xi16>> {tensor_ext.layout = #layout1}, %arg1: !secret.secret<tensor<8xi16>> {tensor_ext.layout = #layout1}) -> (!secret.secret<i16> {tensor_ext.layout = #layout}) {
  ...
  %0 = secret.generic ins(%arg0: !secret.secret<tensor<8xi16>>, %arg1: !secret.secret<tensor<8xi16>>) attrs = {__argattrs = [{tensor_ext.layout = #layout1}, {tensor_ext.layout = #layout1}], __resattrs = [{tensor_ext.layout = #layout}]} {
