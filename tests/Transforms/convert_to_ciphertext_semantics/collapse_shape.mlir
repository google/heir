...
module {
  ...
  func.func @main(%arg4: !secret.secret<tensor<1x784xf32>> {tensor_ext.layout = #new_layout5}) -> (!secret.secret<tensor<784xf32>> {tensor_ext.layout = #new_layout6}) {
    ...
    } -> (!secret.secret<tensor<784xf32>> {tensor_ext.layout = #new_layout6})
...
module {
  // CHECK: func.func @main
  func.func @main(%arg0: tensor<512x784xf32>, %arg4: !secret.secret<tensor<1x784xf32>> {tensor_ext.layout = #new_layout5}) -> (!secret.secret<tensor<512xf32>> {tensor_ext.layout = #new_layout2}) {
