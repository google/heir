...
#row_major_vec = #tensor_ext.layout<map = (d0) -> (d0)>
#col_major_vec = #tensor_ext.layout<map = (d0) -> (d0 * 4)>
...
// CHECK-SAME: tensor_ext.original_type = #tensor_ext.original_type<originalType = !secret.secret<tensor<4x4xi16>>, layout = <map = (d0, d1) -> (d0 * 4 + d1)>>
// CHECK-SAME: -> ([[materialized_ty]] {tensor_ext.original_type = #tensor_ext.original_type<originalType = !secret.secret<tensor<4xi16>>, layout = <map = (d0) -> (d0)>>})
