...
// CHECK-SAME: server.preprocessing_func = {entry_arg_indices = array<i64>, func_name = "linalg"}
...
// CHECK-SAME: (%[[CT:.*]]: ![[ct_L1]])
// CHECK-NEXT:   %[[STORAGE:.*]] = call @linalg__preprocessing()
// CHECK-NEXT:   %[[CALL:.*]] = call @linalg__preprocessed(%[[CT]], %[[STORAGE]])
