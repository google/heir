...
// CHECK-SAME: server.preprocessing_func = {entry_arg_indices = array<i64: 1>, func_name = "hoist_arg"}
...
// CHECK-NEXT:   %[[STORAGE:.*]] = call @hoist_arg__preprocessing(%[[ARG0]])
// CHECK-NEXT:   %[[CALL:.*]] = call @hoist_arg__preprocessed(%[[CT]], %[[ARG0]], %[[STORAGE]])
...
// CHECK-SAME: server.preprocessing_func = {entry_arg_indices = array<i64: 1>, func_name = "hoist_arg_and_constant"}
...
// CHECK-SAME: (%[[CT:.*]]: ![[ct_L1]],
// CHECK-SAME: %[[ARG0:.*]]: tensor<1024xf32>)
// CHECK-NEXT:   %[[STORAGE:.*]] = call @hoist_arg_and_constant__preprocessing(%[[ARG0]])
// CHECK-NEXT:   %[[CALL:.*]] = call @hoist_arg_and_constant__preprocessed(%[[CT]], %[[ARG0]], %[[STORAGE]])
// CHECK-NEXT:   return %[[CALL]]
// CHECK-NEXT: }
...
// CHECK-SAME: server.preprocessing_func = {entry_arg_indices = array<i64: 1>, func_name = "hoist_with_computation"}
...
// CHECK-SAME: (%[[CT:.*]]: ![[ct_L1]],
// CHECK-SAME: %[[ARG0:.*]]: tensor<1x1024xf32>)
// CHECK-NEXT:   %[[STORAGE:.*]] = call @hoist_with_computation__preprocessing(%[[ARG0]])
// CHECK-NEXT:   %[[CALL:.*]] = call @hoist_with_computation__preprocessed(%[[CT]], %[[ARG0]], %[[STORAGE]])
// CHECK-NEXT:   return %[[CALL]]
// CHECK-NEXT: }
