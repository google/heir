...
module attributes {tf_saved_model.semantics} {
  func.func @main(%arg0: tensor<1x1xi8> {iree.identifier = "serving_default_dense_input:0", tf_saved_model.index_path = ["dense_input"]}) -> (tensor<1x1xi32> {iree.identifier = "StatefulPartitionedCall:0", tf_saved_model.index_path = ["dense_2"]}) attributes {tf_saved_model.exported_names = ["serving_default"]} {
    ...
    %9 = "tosa.fully_connected"(%6, %3, %2) {quantization_info = #tosa.conv_quant<input_zp = -0, weight_zp = 0>} : (tensor<1x3xi32>, tensor<3x3xi8>, tensor<3xi32>) -> tensor<1x3xi32>
    %12 = "tosa.fully_connected"(%9, %1, %0) {quantization_info = #tosa.conv_quant<input_zp = 0, weight_zp = 0>} : (tensor<1x3xi32>, tensor<1x3xi8>, tensor<1xi32>) -> tensor<1x1xi32>
    // CHECK: return
