...
// RUN: heir-opt --annotate-module="backend=openfhe scheme=ckks" --mlir-to-ckks='min-slot-count=32 unroll-fhe-kernel-loops=true' --scheme-to-openfhe='entry-function=simple_sum' %s | FileCheck %s
