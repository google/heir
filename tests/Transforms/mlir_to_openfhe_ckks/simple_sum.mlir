...
// RUN: heir-opt --annotate-module="backend=openfhe scheme=ckks" --mlir-to-ckks='min-slot-count=32 experimental-disable-loop-unroll=false' --scheme-to-openfhe='entry-function=simple_sum' %s | FileCheck %s
