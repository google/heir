...
// RUN: not heir-opt --ilp-bootstrap-placement="orbit-cost-model=%S/orbit_incomplete_cost_model.json" %s 2>&1 | FileCheck %s --check-prefix=INCOMPLETE

// MISSING: failed to load Orbit cost model
// MALFORMED: failed to load Orbit cost model
// INCOMPLETE: failed to load Orbit cost model
