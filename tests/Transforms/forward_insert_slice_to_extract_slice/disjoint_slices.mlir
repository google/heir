...
func.func @forward_disjoint_slices() -> tensor<2x2xf32> {
...
func.func @forward_overlapping_slices() -> tensor<2x2xf32> {
  %initial_tensor = tensor.empty() : tensor<4x4xf32>
  %source_tensor = tensor.empty() : tensor<2x2xf32>
  ...
  // CHECK: %[[SOURCE:.*]] = tensor.empty() : tensor<2x2xf32>
  // CHECK: return %[[SOURCE]] : tensor<2x2xf32>
