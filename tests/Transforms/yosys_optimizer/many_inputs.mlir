  ...
  func.func @main(%arg0: !secret.secret<memref<1x1xi16>>) -> (!secret.secret<memref<1x1xi8>>) {
    ...
    affine.for %arg1 = 0 to 1 {
      affine.for %arg2 = 0 to 1 {
        %1 = secret.generic ins(%arg0: !secret.secret<memref<1x1xi16>>, %arg1: index, %arg2: index) {
        ^bb0(%arg3: memref<1x1xi16>, %arg4: index, %arg5: index):
          %3 = memref.load %arg3[%arg4, %arg5] : memref<1x1xi16>
          secret.yield %3 : i16
        } -> !secret.secret<i16>
        %2 = secret.generic ins(%1: !secret.secret<i16>, %c1630361836_i64: i32, %c34359738368_i64: i32, %c0_i32: i16, %c1073741824_i64: i32, %c-1073741824_i64: i32, %c36_i64: i32, %c5_i32: i16, %c-128_i32: i16, %c127_i32: i16) {
        ...
        secret.generic ins(%0: !secret.secret<memref<1x1xi8>>, %2: !secret.secret<i8>, %arg1: index, %arg2: index) {
