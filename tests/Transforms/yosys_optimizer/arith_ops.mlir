...
func.func @ops(
  ...
  %1 = secret.generic ins(%arg0: !secret.secret<i3>, %arg1: !secret.secret<i3>, %arg2: !secret.secret<i3>, %arg3: !secret.secret<i3>) {
...
func.func @truth_table(
  ...
  %1 = secret.generic ins(%arg0: !secret.secret<i1>, %arg1:
           !secret.secret<i1>) {
  ^bb0(%a0: i1, %a1: i1):
