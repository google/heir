...
// CHECK-DAG: [[rm_layout:[^ ]*]] = #tensor_ext.layout<map = (d0, d1) -> (d0 * 32 + d1)>
// CHECK-DAG: [[rm_layout1:[^ ]*]] = #tensor_ext.layout<map = (d0) -> (d0)>
// CHECK-DAG: [[cm_layout:[^ ]*]] = #tensor_ext.layout<map = (d0) -> (d0 * 32)>
