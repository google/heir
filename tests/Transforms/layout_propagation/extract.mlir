...
// The alignment should handle replication to the proper ciphertext size,
// since the linalg.generic layout will only loop over the domain of the
// outshape.
// CHECK: #tensor_ext.alignment<in = [8], out = [1024]>
// CHECK: @dot_product
