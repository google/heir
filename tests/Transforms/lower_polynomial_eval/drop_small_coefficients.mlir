...
// Test polynomial with small coefficients that should be dropped: 1.0 + 1e-15x + 2.0x**2 + 1e-16x**3
#poly_with_small_coeffs = #polynomial.typed_float_polynomial<1.0 + 1.0e-15x + 2.0x**2 + 1.0e-16x**3> : !polyty

// Test polynomial where all coefficients are small and should be dropped
#poly_all_small = #polynomial.typed_float_polynomial<1.0e-15 + 1.0e-16x + 1.0e-17x**2> : !polyty

// Test polynomial with mixed small and large coefficients
