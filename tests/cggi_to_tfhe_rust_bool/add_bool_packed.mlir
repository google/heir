// RUN: heir-opt --cggi-boolean-vectorize -cse --cggi-to-tfhe-rust-bool -remove-dead-values %s | FileCheck %s
...
// CHECK-NOT: cggi
// CHECK-NOT: lwe
// CHECK-COUNT-1: tfhe_rust_bool.gates_packed %arg0, {{%.*}}, {{%.*}} {gates = #tfhe_rust_bool.tfhe_rust_bool_gate<"and", "xor">} : (!tfhe_rust_bool.server_key, tensor<2x!tfhe_rust_bool.eb
// CHECK-COUNT-6: tfhe_rust_bool.gates_packed %arg0, {{%.*}}, {{%.*}} {gates = #tfhe_rust_bool.tfhe_rust_bool_gate<"xor", "xor">} : (!tfhe_rust_bool.server_key, tensor<2x!tfhe_rust_bool.eb
// CHECK-COUNT-1: tfhe_rust_bool.gates_packed %arg0, {{%.*}}, {{%.*}} {gates = #tfhe_rust_bool.tfhe_rust_bool_gate<"xor", "xor", "xor", "xor", "xor", "xor", "xor", "xor", "xor">} : (!tfhe_rust_bool.server_key, tensor<9x!tfhe_rust_bool.eb
