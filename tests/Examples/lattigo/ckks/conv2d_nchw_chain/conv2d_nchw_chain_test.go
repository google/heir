...
import (
	...
	"tests/Examples/lattigo/ckks/conv2d_nchw_chain/conv2d_nchw_chain_utils"
)
...
func TestConv2dChain(t *testing.T) {
	...
	startPre := time.Now()
	filterPlains := conv2d_nchw_chain_utils.Conv2d_chain__preprocessing(params, ecd)
