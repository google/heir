...
import tests.Examples.openfhe.ckks.mnist._heir_mnist_openfhe as mnist

K_MODEL_PATH = "tests/Examples/openfhe/ckks/mnist/data/traced_model.pt"
K_DATA_PATH = "tests/Examples/openfhe/ckks/mnist/data"
...
class MNISTTest(absl.testing.absltest.TestCase):
  ...
  def test_run_test(self):
    weights = load_weights(K_MODEL_PATH)
    ...
    test_dataset = CustomMNISTTestDataset(data_root=K_DATA_PATH)
