...
module {
  func.func @fn_under_test(%arg0: memref<8x!ct_ty>) -> memref<8x!ct_ty> {
    ...
    %4 = lwe.encode %0 { plaintext_bits = 3 : index } : i1 to !pt_ty
    ...
    %9 = lwe.encode %7 { plaintext_bits = 3 : index } : i1 to !pt_ty
    ...
    %41 = lwe.encode %39 { plaintext_bits = 3 : index } : i1 to !pt_ty
    %42 = lwe.trivial_encrypt %41   : !pt_ty -> !ct_ty
