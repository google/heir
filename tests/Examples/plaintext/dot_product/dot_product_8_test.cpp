...
extern "C" {
void _mlir_ciface_dot_product(StridedMemRefType<int16_t>* result,
                              StridedMemRefType<int16_t>* arg0,
                              StridedMemRefType<int16_t>* arg1);

void _mlir_ciface_dot_product__encrypt__arg0(StridedMemRefType<int16_t>* result,
                                             StridedMemRefType<int16_t>* arg);
void _mlir_ciface_dot_product__encrypt__arg1(StridedMemRefType<int16_t>* result,
                                             StridedMemRefType<int16_t>* arg);
