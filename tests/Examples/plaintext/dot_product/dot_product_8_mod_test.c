...
// <nxi64>
memref_1d dot_product__encrypt__arg0(
    /* arg <nxi16> */
    int16_t *allocated, int16_t *aligned, int64_t offset, int64_t size,
    int64_t stride);
// <nxi64>
memref_1d dot_product__encrypt__arg1(
    /* arg <nxi16> */
    int16_t *allocated, int16_t *aligned, int64_t offset, int64_t size,
    int64_t stride);
...
int main() {
  // Must align with MLIR input type
  ...
  // logic
  memref_1d encArg0 = dot_product__encrypt__arg0(
      /* arg 0*/
      arg0, arg0, 0, 8, 1);
  memref_1d encArg1 = dot_product__encrypt__arg1(
      /* arg 0*/
      arg1, arg1, 0, 8, 1);

  memref_1d packedRes = dot_product(
      /* arg 0*/
