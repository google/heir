...
extern "C" {
void _mlir_ciface_dot_product(StridedMemRefType<int64_t>* result,
                              StridedMemRefType<int64_t>* arg0,
                              StridedMemRefType<int64_t>* arg1);

void _mlir_ciface_dot_product__encrypt__arg0(StridedMemRefType<int64_t>* result,
                                             StridedMemRefType<int16_t>* arg);
void _mlir_ciface_dot_product__encrypt__arg1(StridedMemRefType<int64_t>* result,
                                             StridedMemRefType<int16_t>* arg);

int16_t _mlir_ciface_dot_product__decrypt__result0(
    StridedMemRefType<int64_t>* arg);
}

TEST(DotProductMod8Test, Test1) {
