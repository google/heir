...
memref_1d_f32 dot_product__encrypt__arg0(
    /* arg*/
    float* allocated, float* aligned, int64_t offset, int64_t size,
    int64_t stride);
memref_1d_f32 dot_product__encrypt__arg1(
    /* arg*/
    float* allocated, float* aligned, int64_t offset, int64_t size,
    int64_t stride);
...
int main() {
  ...
  // logic
  memref_1d_f32 encArg0 = dot_product__encrypt__arg0(
      /* arg 0*/
      arg0, arg0, 0, 8, 1);
  memref_1d_f32 encArg1 = dot_product__encrypt__arg1(
      /* arg 0*/
      arg1, arg1, 0, 8, 1);

  // Main function
  memref_1d_f32 packedRes = dot_product(
      /* arg 0*/
