...
module attributes {scheme.ckks} {
  func.func @linear_transform(%evaluator: !evaluator, %param: !param, %encoder: !encoder, %ct: !ct, %arg0: tensor<2x4096xf64> {orion.block_col = 0 : i64, orion.block_row = 0 : i64, orion.layer_name = "fc1", orion.layer_role = "weights", orion.level = 5 : i64}) -> !ct {
    %ct_0 = lattigo.ckks.linear_transform %evaluator, %ct, %arg0 {levelQ = 5 : i32, logBabyStepGiantStepRatio = 2 : i64} : (!evaluator, !ct, tensor<2x4096xf64>) -> !ct
