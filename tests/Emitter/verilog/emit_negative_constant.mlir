...
module {
  memref.global "private" constant @__constant : memref<2xi8> = dense<[-1, -2]> alignment = 64
  memref.global "private" constant @__constant_i32 : memref<1xi32> = dense<-7217> alignment = 64
