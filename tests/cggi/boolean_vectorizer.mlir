...
// CHECK-COUNT-6: cggi.packed_gates {{%.*}}, {{%.*}} {gates = #cggi.cggi_bool_gates<4 : i32, 4 : i32>} : (tensor<2x!lwe.lwe_ciphertext
// CHECK-COUNT-7: cggi.packed_gates {{%.*}}, {{%.*}} {gates = #cggi.cggi_bool_gates<0 : i32, 0 : i32>} : (tensor<2x!lwe.lwe_ciphertext
