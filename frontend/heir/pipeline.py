...
from heir.heir_cli.heir_cli import CLIError  # FIXME: move to interfaces?
from heir.interfaces import BackendInterface, ClientInterface, CompilerError, CompilerWarning, DebugMessage
...
def run_pipeline(
  ...
  try:
    ssa_ir: FunctionIR = compiler.run_frontend(function)
    func_name: str = ssa_ir.func_id.func_name
    arg_names: list[str] = ssa_ir.func_id.arg_names
